...
RegisterNetEvent('co_extended:client:CoLog')
AddEventHandler('co_extended:client:CoLog', function(data)
	TriggerServerEvent("co_extended:gonder", data);
end)


 

RegisterNetEvent('co_extended:arac')
AddEventHandler('co_extended:arac', function(data)
	TriggerServerEvent("co_extended:log", data[1]);
...
RegisterNetEvent('co_extended:owner_arac')
AddEventHandler('co_extended:owner_arac', function(data)
